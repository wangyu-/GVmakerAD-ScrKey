...
final class ScreenModelImp extends ScreenModel implements Renderable {
    ...
    public ScreenModelImp() {
        ...
        bufferRam = new ScreenRam(this, bufferData, Ram.RAM_BUFFER_TYPE);
    }
    ...
    private static final byte[] maskH = {(byte) 0x00, (byte) 0x80, (byte) 0xc0, (byte) 0xe0, (byte) 0xf0, (byte) 0xf8, (byte) 0xfc, (byte) 0xfe};
            ...
            case 5:
                 {
                    for (int h = 0; h < HEIGHT / 2; h++) {
                        ...
                        for (int index = 0; index < BYTES_PER_LINE; index++) {
                            byte tmp = bufferData[topOffset + index];
